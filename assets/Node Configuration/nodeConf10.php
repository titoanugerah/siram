...
$conn->close();
 ...
 unset($client); 
  ...
  if ($message->topic=="/data2/suhu10"){
    $sql = "INSERT INTO t_suhu (topik, suhu, waktu, kode_tanaman)
    VALUES ('$message->topic', '$message->payload', NOW(), 'T-01-0010')";
  }

  if ($message->topic=="/data2/dew10"){
    $sql = "INSERT INTO t_dew (topik, dew, waktu, kode_tanaman)
    VALUES ('$message->topic', '$message->payload', NOW(), 'T-01-0010')";
  }

  if ($message->topic=="/data2/tanah10"){
    $sql = "INSERT INTO t_tanah (topik, tanah, waktu, kode_tanaman)
    VALUES ('$message->topic', '$message->payload', NOW(), 'T-01-0010')";
  }

  if ($message->topic=="/data2/udara10"){
