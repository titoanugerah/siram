     ...
     <div class="col-md-3">
       ...
       <div class="box box-primary">
         <div class="box-body box-profile">
           ...
           <p class="text-muted text-center"><?php echo $this->session->userdata['nama_perpustakaan']; ?></p>
       ...
       <div class="box box-primary">
         <div class="box-header with-border">
           <h3 class="box-title">Tentang perpustakaan</h3>
         </div>
         <!-- /.box-header -->
         <div class="box-body">
           ...
           <p class="text-muted">
             <?php echo $this->session->userdata['nama_perpustakaan']; ?>
           </p>
           ...
           <p class="text-muted"><?php echo $this->session->userdata['alamat_perpustakaan']; ?></p>

           <hr>

           <strong><i class="fa fa-map margin-r-5"></i> Kota</strong>
           <p class="text-muted"><?php echo $this->session->userdata['nama_kota'].", ".$this->session->userdata['provinsi_kota']; ?></p>
           <hr>
