...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="" method="post" value='user_login'>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" value="adminValidation" name="adminValidation">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <!-- /.social-auth-links -->
    <a href="userLogin">Login Pengguna</a><br>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
