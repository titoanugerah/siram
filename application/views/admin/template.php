<?php
if ((!$this->session->userdata['login']) || ($this->session->userdata['previlleges']!='admin')) {
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
            <a href="<?php echo base_url('rekapNode'); ?>">
              <i class="fa fa-code-fork"></i> <span>Rekap Node</span>
            </a>
        </li>
        <li>
          <a href="<?php echo base_url('createNode'); ?>">
            <i class="fa fa-plus "></i><span>Tambah Node</span></a>
        </li>
   ...
   $(function () {
      ...
      */
      ...
      foreach ($dataNode as $item):
        ...
        } elseif ($view_name=='tanah') {
          $devPoint[] = $item->data_value;
        } elseif ($view_name=='udara') {
          $devPoint[] = $item->data_value;
        } elseif ($view_name=='dewPoint') {
          $devPoint[] = $item->data_value;
        } else {
          $devPoint[] = $item->data;
        }
